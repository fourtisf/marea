...
export const VILLA_RATE_PER_SEC = 0.5;      // passive Credits while you own a villa
export const FISH_DUR = 4;                  // seconds to land a catch
export const FISH_PAY = 6;                  // base Credits for casting (plus the fish)
